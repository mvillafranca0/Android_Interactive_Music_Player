...
public class boomer_kuwanger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boomer_kuwanger);

        replayButton = findViewById(R.id.replay);
        play_pauseButton = findViewById(R.id.play_pause);
        loopButton = findViewById(R.id.loop);

        actVideo = findViewById(R.id.bk_stage);
        actVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.bk_stage));
    ...
    protected void onResume() {
        ...
        bgPlayer = MediaPlayer.create(this, R.raw.boomer_kuwanger);
