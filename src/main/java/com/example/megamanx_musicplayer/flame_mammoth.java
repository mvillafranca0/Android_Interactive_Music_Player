...
public class flame_mammoth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flame_mammoth);

        replayButton = findViewById(R.id.replay);
        play_pauseButton = findViewById(R.id.play_pause);
        loopButton = findViewById(R.id.loop);

        actVideo = findViewById(R.id.fm_stage);
        actVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.fm_stage));
    ...
    protected void onResume() {
        ...
        bgPlayer = MediaPlayer.create(this, R.raw.flame_mammoth);
