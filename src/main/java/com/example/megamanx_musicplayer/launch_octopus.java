...
public class launch_octopus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_launch_octopus);

        replayButton = findViewById(R.id.replay);
        play_pauseButton = findViewById(R.id.play_pause);
        loopButton = findViewById(R.id.loop);

        actVideo = findViewById(R.id.lo_stage);
        actVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.lo_stage));
    ...
    protected void onResume() {
        ...
        bgPlayer = MediaPlayer.create(this, R.raw.launch_octopus);
