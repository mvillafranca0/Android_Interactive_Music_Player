...
public class megaman_x extends AppCompatActivity {
    ...
    private VideoView intVideo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_megaman_x);

        replayButton = findViewById(R.id.replay);
        play_pauseButton = findViewById(R.id.play_pause);
        loopButton = findViewById(R.id.loop);

        intVideo = findViewById(R.id.mx_intro);
        intVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.mx_intro));
        intVideo.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
            @Override
        ...
        actVideo = findViewById(R.id.mx_stage);
        actVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.mx_stage));
    ...
    protected void onResume() {
        ...
        bgPlayer = MediaPlayer.create(this, R.raw.first_stage);
