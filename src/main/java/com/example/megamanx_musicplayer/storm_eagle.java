...
public class storm_eagle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_storm_eagle);

        replayButton = findViewById(R.id.replay);
        play_pauseButton = findViewById(R.id.play_pause);
        loopButton = findViewById(R.id.loop);

        actVideo = findViewById(R.id.se_stage);
        actVideo.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.se_stage));
    ...
    protected void onResume() {
        ...
        bgPlayer = MediaPlayer.create(this, R.raw.storm_eagle);
